...
int SubInt(int a, int b) =>
    a - b; // arrow function for one line function (shortcut)
...
String Colorize(String msg, String Function(String) color) =>
    color(msg); // function parameter
